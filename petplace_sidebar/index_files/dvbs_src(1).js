...
verRegex:null},{id:0,brRegex:"AOL/.*AOLBuild/|AOLBuild/.*AOL/|Puffin|Maxthon|Valve|Silk|PLAYSTATION|PlayStation|Nintendo|wOSBrowser",verRegex:null},{id:3,brRegex:"Chrome",verRegex:"Chrome/"},{id:5,brRegex:"Safari|(OS |OS X )[0-9].*AppleWebKit",verRegex:"Version/"}];h=0;m="";for(var f=0;f<g.length;f++)if(null!=n.match(RegExp(g[f].brRegex))){h=g[f].id;if(null==g[f].verRegex)break;n=n.match(RegExp(g[f].verRegex+"[0-9]*"));null!=n&&(m=n[0].match(RegExp(g[f].verRegex)),m=n[0].replace(m[0],""));break}g=
f=O();m=f===h?m:"";window._dv_win.$dvbs.CommonData.BrowserId=g;window._dv_win.$dvbs.CommonData.BrowserVersion=m;window._dv_win.$dvbs.CommonData.BrowserIdFromUserAgent=h}i+="&brid="+g+"&brver="+m+"&bridua="+h;(h=dv_GetParam(a,"turl"))&&(i+="&turl="+h);(h=dv_GetParam(a,"tagformat"))&&(i+="&tagformat="+h);var A;h=function(){try{return!!window.sessionStorage}catch(b){return!0}};m=function(){try{return!!window.localStorage}catch(b){return!0}};g=function(){var b=document.createElement("canvas");if(b.getContext&&
b.getContext("2d")){var a=b.getContext("2d");a.textBaseline="top";a.font="14px 'Arial'";a.textBaseline="alphabetic";a.fillStyle="#f60";a.fillRect(0,0,62,20);a.fillStyle="#069";a.fillText("!image!",2,15);a.fillStyle="rgba(102, 204, 0, 0.7)";a.fillText("!image!",4,17);return b.toDataURL()}return null};try{f=[];f.push(["lang",navigator.language||navigator.browserLanguage]);f.push(["tz",(new Date).getTimezoneOffset()]);f.push(["hss",h()?"1":"0"]);f.push(["hls",m()?"1":"0"]);f.push(["odb",typeof window.openDatabase||
""]);f.push(["cpu",navigator.cpuClass||""]);f.push(["pf",navigator.platform||""]);f.push(["dnt",navigator.doNotTrack||""]);f.push(["canv",g()]);var p=f.join("=!!!=");if(null==p||""==p)A="";else{h=function(b){for(var a="",c,d=7;0<=d;d--)c=b>>>4*d&15,a+=c.toString(16);return a};m=[1518500249,1859775393,2400959708,3395469782];var p=p+String.fromCharCode(128),y=Math.ceil((p.length/4+2)/16),z=Array(y);for(g=0;g<y;g++){z[g]=Array(16);for(f=0;16>f;f++)z[g][f]=p.charCodeAt(64*g+4*f)<<24|p.charCodeAt(64*g+
4*f+1)<<16|p.charCodeAt(64*g+4*f+2)<<8|p.charCodeAt(64*g+4*f+3)}z[y-1][14]=8*(p.length-1)/Math.pow(2,32);z[y-1][14]=Math.floor(z[y-1][14]);z[y-1][15]=8*(p.length-1)&4294967295;var p=1732584193,f=4023233417,n=2562383102,G=271733878,H=3285377520,t=Array(80),B,u,w,x,I;for(g=0;g<y;g++){for(var l=0;16>l;l++)t[l]=z[g][l];for(l=16;80>l;l++)t[l]=(t[l-3]^t[l-8]^t[l-14]^t[l-16])<<1|(t[l-3]^t[l-8]^t[l-14]^t[l-16])>>>31;B=p;u=f;w=n;x=G;I=H;for(l=0;80>l;l++){var D=Math.floor(l/20),E=B<<5|B>>>27,C;c:{switch(D){case 0:C=
...
"&num=6"+i+"&srcurlD="+d.depth+"&ssl="+b.ssl+"&refD="+F+b.tagIntegrityFlag+b.tagHasPassbackFlag+"&htmlmsging="+(v?"1":"0")+(null!=A?"&aadid="+A:"");(d=dv_GetDynamicParams(a).join("&"))&&(b+="&"+d);if(!1===k||r)b=b+("&dvp_isBodyExistOnLoad="+(k?"1":"0"))+("&dvp_isOnHead="+(r?"1":"0"));c="srcurl="+encodeURIComponent(c);if((k=window._dv_win[K("=@42E:@?")][K("2?46DE@C~C:8:?D")])&&0<k.length){r=[];r[0]=window._dv_win.location.protocol+"//"+window._dv_win.location.hostname;for(d=0;d<k.length;d++)r[d+1]=
k[d];k=r.reverse().join(",")}else k=null;k&&(c+="&ancChain="+encodeURIComponent(k));k=4E3;/MSIE (\d+\.\d+);/.test(navigator.userAgent)&&7>=new Number(RegExp.$1)&&(k=2E3);if(a=dv_GetParam(a,"referrer"))a="&referrer="+a,b.length+a.length<=k&&(b+=a);s.length+q.length+b.length<=k&&(b+=q,c+=s);return b+="&eparams="+encodeURIComponent(K(c))+"&"+e.getVersionParamName()+"="+e.getVersion()}function N(e){try{if(1>=e.depth)return{url:"",depth:""};var b,c=[];c.push({win:window._dv_win.top,depth:0});for(var d,
a=1,i=0;0<a&&100>i;){try{if(i++,d=c.shift(),a--,0<d.win.location.toString().length&&d.win!=e)return 0==d.win.document.referrer.length||0==d.depth?{url:d.win.location,depth:d.depth}:{url:d.win.document.referrer,depth:d.depth-1}}catch(v){}b=d.win.frames.length;for(var k=0;k<b;k++)c.push({win:d.win.frames[k],depth:d.depth+1}),a++}return{url:"",depth:""}}catch(r){return{url:"",depth:""}}}function K(e){new String;var b=new String,c,d,a;for(c=0;c<e.length;c++)a=e.charAt(c),d="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(a),
...
0<=document.documentMode||void 0!=document.all&&"object"==typeof document.all||void 0!=window.ActiveXObject&&"function"==typeof window.ActiveXObject)||window.document&&window.document.updateSettings&&"function"==typeof window.document.updateSettings)return 1;var b=!1;try{var c=document.createElement("p");c.innerText=".";c.style="text-shadow: rgb(99, 116, 171) 20px -12px 2px";b=void 0!=c.style.textShadow}catch(d){}return 0<Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor")&&
b&&void 0!=window.innerWidth&&void 0!=window.innerHeight?5:0}catch(a){return 0}}this.createRequest=function(){var e=!1,b=window._dv_win,c=0,d=!1;try{for(dv_i=0;10>=dv_i;dv_i++)if(null!=b.parent&&b.parent!=b)if(0<b.parent.location.toString().length)b=b.parent,c++,e=!0;else{e=!1;break}else{0==dv_i&&(e=!0);break}}catch(a){e=!1}0==b.document.referrer.length?e=b.location:e?e=b.location:(e=b.document.referrer,d=!0);window._dv_win._dvScripts||(window._dv_win._dvScripts=[]);var i=document.getElementsByTagName("script");
for(dv_i in i)if(i[dv_i].src){var v=i[dv_i].src,k=window._dv_win.dv_config.bs_regex||/^[ \t]*(http(s)?:\/\/)?[a-z\-]*cdn(s)?\.doubleverify\.com:?[0-9]*\/dvbs_src\.js/;if(v&&v.match(k)&&!dv_Contains(window._dv_win._dvScripts,i[dv_i])){this.dv_script=i[dv_i];window._dv_win._dvScripts.push(i[dv_i]);var r;r=window._dv_win.dv_config?window._dv_win.dv_config.bst2tid?window._dv_win.dv_config.bst2tid:window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():D():D();var g,k=window.parent.postMessage&&
window.JSON,m=!0,h=!1;if("0"==dv_GetParam(v,"t2te")||window._dv_win.dv_config&&!0==window._dv_win.dv_config.supressT2T)h=!0;if(k&&!1==h)try{var s=window._dv_win.dv_config.bst2turl||"https://cdn3.doubleverify.com/bst2tv3.html",h="bst2t_"+r,q=void 0;if(document.createElement&&(q=document.createElement("iframe")))q.name=q.id=window._dv_win.dv_config.emptyIframeID||"iframe_"+D(),q.width=0,q.height=0,q.id=h,q.style.display="none",q.src=s;g=q;m=J(g)}catch(F){}var j;g=v;s={};try{for(var n=RegExp("[\\?&]([^&]*)=([^&#]*)",
"gi"),f=n.exec(g);null!=f;)"eparams"!==f[1]&&(s[f[1]]=f[2]),f=n.exec(g);j=s}catch(A){j=s}j.uid=r;j.script=this.dv_script;j.callbackName="__verify_callback_"+j.uid;j.tagObjectCallbackName="__tagObject_callback_"+j.uid;j.tagAdtag=null;j.tagPassback=null;j.tagIntegrityFlag="";j.tagHasPassbackFlag="";!1==(null!=j.tagformat&&"2"==j.tagformat)&&(n=M(j.script),j.tagAdtag=n.tagAdTag,j.tagPassback=n.tagPassback,n.isBadImp?j.tagIntegrityFlag="&isbadimp=1":n.hasPassback&&(j.tagHasPassbackFlag="&tagpb=1"));j.protocol=
"http:";j.ssl="0";"https"==j.script.src.match("^https")&&"https"==window._dv_win.location.toString().match("^https")&&(j.protocol="https:",j.ssl="1");L(j);return E(this,j,e,b,c,d,k,m,i[dv_i]&&i[dv_i].parentElement&&i[dv_i].parentElement.tagName&&"HEAD"===i[dv_i].parentElement.tagName)}}};this.sendRequest=function(e){var b=dv_GetParam(e,"tagformat");b&&"2"==b?$dvbs.domUtilities.addScriptResource(e,document.body):dv_sendScriptRequest(e);return!0};this.isApplicable=function(){return!0};this.onFailure=
function(){var e=window._dv_win._dvScripts,b=this.dv_script;null!=e&&(void 0!=e&&b)&&(b=e.indexOf(b),-1!=b&&e.splice(b,1))};window.debugScript&&(window.CreateUrl=E);this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"24"}};
