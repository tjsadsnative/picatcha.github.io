...
var ft1536182 = {
	params:window.ftParams_1536182||"",
	confID:window.ftConfID_1536182||"0",
	guid:window.ftGUID_1536182||"99999999999",
	ftId:'',
    ftImpId: window.ftImp1536182 && ftImp1536182.impID || '',
	pID:1536182,
	creativeID:"1233364",
	campaignID: "55481",
	exttrack:[],
	...
	width:"300",
	height:"250",
	altimg:"http://cdn.flashtalking.com/xre/153/1536182/1233364/image/1233364.gif",
	viewableImpressionURL: "http://servedby.flashtalking.com/imp/4/55481;1536182;202;pixel;DstilleryUS;2016DSTURBANSDisplayAftonAlpsAA13ResortGeofenceMid300x250/?",
    stump: "http://servedby.flashtalking.com",
	altimghref:"http://servedby.flashtalking.com/click/4/55481;1536182;1233364;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://apiservices.krxd.net/click_tracker/track?kxconfid=JkXuCjO1&kxadvertiserid=5203&kxcampaignid=55481&kxplacementid=1536182&kxcreativeid=1233364&kxsiteid=8626&kxsitename=DstilleryUS&clk=http://www.aftonalps.com/lessons,-racing,-program-information/youth-teen-7-17?cmpid=BACURB03012",
	switchArray:["altimg", "altimghref", "cdnSrc", "cdnGUID", "iDeviceImp", "statBaseURL", "viewableImpressionURL", "cdnSrc", "iDeviceImp"],
	statBaseURL:"http://stat.flashtalking.com/reportV3/ft.stat?58907994-",
	divID:"ftdiv1536182",
	altimgID:"ftalt1536182",
    imgID: "ftImg1536182",
    frameID:"ftframe1536182",
	alttext:"Click here",
	altimgtarget:"_blank",
	altimgborder:"0",
	centreAd:true,
	...
	iDeviceImp:"http://servedby.flashtalking.com/imp/4/55481;1536182;207;guid;DstilleryUS;2016DSTURBANSDisplayAftonAlpsAA13ResortGeofenceMid300x250/?ft_guid=",
	secure: location.protocol === 'https:'||!!(document.querySelector&&document.querySelector('#ftscript_m1536182[src^="https:"]')) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc','')),
	adDisplayed: false,
    w: window,
    qsVars:[
        ["ftguid","ftGUID_1536182"],
        ["ftcfid","ftConfID_1536182"],
        ["ftcustom","ftCustom_1536182"],
        ["fttime","ftTimestamp_1536182"],
        ["ftsection","ftSection_1536182"],
        ["ft_id", "ftID"],
        ['ftimpid', 'ftImp1536182', 'impID']
    ],
	api: {
		fallbackAPI: {
            ft: null,
	...
	scriptLocation: document.getElementById('ftscript_m1536182'),
	$:function(el){
		var o=this,
		x = el||o.divID,
		p={o:o};
	...
	outputDiv:function(frame){
		...
		div += o[content]();
		div += '</div>';
		if(window.ftImp1536182 && ftImp1536182.jsAppend) {
...
(function(ft){
    ...
    var ua = navigator.userAgent;
    var safari = /Safari/.test(ua) && !/Chrome/.test(ua) && !/Edge/.test(ua);
    var externalURL = (ft.secure?"https":"http") + "://cdn.flashtalking.com/pageFold/ftpagefold_v4.4.0.js",
        extScript = null,
        adIsVisible = false;
