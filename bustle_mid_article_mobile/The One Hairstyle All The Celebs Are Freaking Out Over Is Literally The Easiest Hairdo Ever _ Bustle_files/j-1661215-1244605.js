...
var ft1661215 = {
	confID:window.ftConfID_1661215||"0",
	GUID:window.ftGUID_1661215||"99999999999",
	ftId:'',
    ftImpId: window.ftImp1661215 && window.ftImp1661215.impID || '',
	params:window.ftParams_1661215||"",
	segment:window.ftSegment_1661215||"",
	segmentList:window.ftSegmentList_1661215||[],
	keyword:window.ftKeyword_1661215||"",
	ftReturn: window.ftReturn_1661215||"",
	exttrack:[],
	extscript:[""],
	pID:"1661215",
	cID:"52835",
	campaignID:"58197",
	siteName:"MediaMath",
	placementDescription:"SLNGDUSATONNAGMWDISMT1PPRxxxxxxxxxxDEVICExxxxxxxx320x050",
	creativeID:"1244605",
	width:320,
	height:50,
	divID:"ftdiv1661215",
	frameID:"ftframe1661215",
	altImgID:"ftalt1661215",
	altText:"Click here",
	altImgTarget:"_blank",
	altImgHref:"http://servedby.flashtalking.com/click/8/58197;1661215;1244605;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=320&ft_height=50&url=https://www.sling.com/devices?cvosrc=Display.MediaMath.TONNAG&cvo_strategy=[FT_MMSTRATEGY]&cvo_dealid=[FT_MMDEALID]&cvo_site=[FT_MMDOMAIN]&cvo_versionid=[FT_CONFID]&cvo_pid=SLNGD_USA_TONNAG_MW_DIS_MT1_PPR_xxxxxxxxxx_DEVICEx_xxxxxxx_320x050",
    tracking3rdParty: {
        videoQuartiles: JSON.parse('[%thirdparty_video_quartiles%]'.replace(/^(\[%\w+%])?$/, '{}')),
        userEngagement: '[%thirdparty_user_engagement%]'.replace(/^\[%\w+%\]$/, '')
    },
	clickTags: ["http://servedby.flashtalking.com/click/8/58197;1661215;1244605;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=320&ft_height=50&url=https://www.sling.com/devices?cvosrc=Display.MediaMath.TONNAG&cvo_strategy=[FT_MMSTRATEGY]&cvo_dealid=[FT_MMDEALID]&cvo_site=[FT_MMDOMAIN]&cvo_versionid=[FT_CONFID]&cvo_pid=SLNGD_USA_TONNAG_MW_DIS_MT1_PPR_xxxxxxxxxx_DEVICEx_xxxxxxx_320x050"],
	altImg:"http://servedby.flashtalking.com/imp/8/58197;1661215;204;gif;MediaMath;SLNGDUSATONNAGMWDISMT1PPRxxxxxxxxxxDEVICExxxxxxxx320x050/?",
	viewableImpressionURL: "http://servedby.flashtalking.com/imp/8/58197;1661215;202;pixel;MediaMath;SLNGDUSATONNAGMWDISMT1PPRxxxxxxxxxxDEVICExxxxxxxx320x050/?",
    stump: "http://servedby.flashtalking.com",
	file:"http://cdn.flashtalking.com/52835/1244605/index.html",
	serveDOM:"http://cdn.flashtalking.com",
	switchArray:["altImg","file", "serveDOM", "statBaseURL","altImgHref", "viewableImpressionURL"],
	statBaseURL:"http://stat8.flashtalking.com/reportV3/ft.stat?61889321-",
	centreAd:true,
	adWindow:null,
	mvt:false,
	blockBrowsers:"".split(","),
	...
	secure: location.protocol === 'https:'||!!(document.querySelector&&document.querySelector('#ftscript_m1661215[src^="https:"]')) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc','')),
	storeGUID:/iP(ad|hone|od)/.test(navigator.appVersion),
	scriptLocation: document.getElementById('ftscript_m1661215'),
	customPos: false,
	...
	outputDiv:function(fullAd){
		...
		if(badWrite || (window.ftImp1661215 && window.ftImp1661215.jsAppend)) {
...
(function(o) {
  ...
  var mmReplace = function(s) {
    ...
    trackUrl = mmReplace("https://dishdigital.sp1.convertro.com/view/vt/v1/dishdigital/15/cvo.gif?cvosrc=Display.MediaMath.TONNAG&cvo_strategy=[FT_MMSTRATEGY]&cvo_dealid=[FT_MMDEALID]&cvo_site=[FT_MMDOMAIN]&cvo_versionid=[FT_CONFID]&cvo_pid=SLNGD_USA_TONNAG_MW_DIS_MT1_PPR_xxxxxxxxxx_DEVICEx_xxxxxxx_320x050");
