...
function dv_handler69(){function K(d){if(window._dv_win.document.body)return window._dv_win.document.body.insertBefore(d,window._dv_win.document.body.firstChild),!0;var a=0,c=function(){if(window._dv_win.document.body)try{window._dv_win.document.body.insertBefore(d,window._dv_win.document.body.firstChild)}catch(e){}else a++,150>a&&setTimeout(c,20)};setTimeout(c,20);return!1}function ba(d){var a;if(document.createElement&&(a=document.createElement("iframe")))a.name=a.id=window._dv_win.dv_config.emptyIframeID||
...
try {
	...
	dv_handler69.prototype = dv_baseHandlerIns;
dv_handler69.prototype.constructor = dv_handler69;

    var dv_handlersDefs = [{handler: new dv_handler69(), minRate: 0, maxRate: 90}];
