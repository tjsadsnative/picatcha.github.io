document.write('<iframe id="pbSekindo_6068756832489de599"  FRAMEBORDER="0" SCROLLING="no" MARGINHEIGHT="0" MARGINWIDTH="0" TOPMARGIN="0" LEFTMARGIN="0" ALLOWTRANSPARENCY="true" WIDTH="300" HEIGHT="250"></iframe>');
    ...
    pbjs.que.push(function(){
		pbjs.requestBids({
            bidsBackHandler: function(bidResponses)
            {
				...
				var el = document.getElementById('pbSekindo_6068756832489de599');
				for(var i in bidResponses.pbSekindo_6068756832489de599.bids)
				{
					if( parseFloat(bidResponses.pbSekindo_6068756832489de599.bids[i].cpm) > parseFloat(maxCpm)*parseFloat(bidResponses.pbSekindo_6068756832489de599.bids[i].flrAdjst))
					{
						maxCpm = bidResponses.pbSekindo_6068756832489de599.bids[i].cpm;
						winnerBid = bidResponses.pbSekindo_6068756832489de599.bids[i];
					}
				}
