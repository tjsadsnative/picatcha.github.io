...
return $iTXT.core.Util.getPosition(el);},getBoundingBox:function(){var pos=this.getPosition();var wrd=this.getWordNode();return{top:pos.top,left:pos.left,width:wrd.offsetWidth,height:wrd.offsetHeight,target:wrd};},setHookStyle:function(s,as)
{if(s)
