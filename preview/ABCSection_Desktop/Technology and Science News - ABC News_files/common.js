...
function setStoryTextFont(size) {
	...
	if (size == 'small') {
			for (i=0; i<img.length; i++) {
				var className = img[i].className;
				if (className == 'font_sm') {
					img[i].src = base_url+'/images/font-sm_on2.gif';
				} else if (className == 'font_md') {
					img[i].src = base_url+'/images/font-md_off2.gif';
				} else if (className == 'font_lg') {
					img[i].src = base_url+'/images/font-lg_off2.gif';
				}
			}
			document.getElementById('storyText').className='storyTextSm';
	} else if (size == 'large') {
			for (i=0; i<img.length; i++) {
				var className = img[i].className;
				if (className == 'font_sm') {
					img[i].src = base_url+'/images/font-sm_off2.gif';
				} else if (className == 'font_md') {
					img[i].src = base_url+'/images/font-md_off2.gif';
				} else if (className == 'font_lg') {
					img[i].src = base_url+'/images/font-lg_on2.gif';
				}
			}
			document.getElementById('storyText').className='storyTextLg';
			...
			for (i=0; i<img.length; i++) {
				...
				if (className == 'font_sm') {
					...
					img[i].src = base_url+'/images/font-md_on2.gif';
				} else if (className == 'font_lg') {
					img[i].src = base_url+'/images/font-lg_off2.gif';
				}
			}
			document.getElementById('storyText').className='storyTextMd';
	}
