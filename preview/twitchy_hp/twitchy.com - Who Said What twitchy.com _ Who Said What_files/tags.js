...
if (e9Manager === undefined || e9Manager.init === false)
   ...
   e9Manager = (
	...
	e9Manager = manager;
        ...
        var e9Page = 
	 {
	   ...
	   tagOptions: {"snackBar":{"serveSnackBar":false, "snackBarClose":false}, "isDebugActualTagSize":true, "allowTurnOffPageSafetyFromTags":true, "allowPageUrlFromTags":true},
...
else
 {
   if (e9 !== undefined) 
    {
      e9Manager.setSite("appnexusaero","mazdaaero_set1");
