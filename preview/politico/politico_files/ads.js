...
var exclude_from_auto_load = '[{"ad_type":"x02","page_key":"magazine-opinionstory"},{"ad_type":"x02","page_key":"magazine-story"},{"ad_type":"x02","page_key":"magazine-opinionstorytest"},{"ad_type":"x02","page_key":"magazine-storytest"}]';
	...
	googletag.cmd.push(function(){
		$.each(jsonStruct, function(i, item){
         var n=i; 
			...
			if (i != 'x02' && (PP_pagekey != 'magazine-opinionstory' || PP_pagekey != 'magazine-story' || PP_pagekey != 'magazine-opinionstorytest' || PP_pagekey != 'magazine-storytest')) {
				gptadslots[i]=googletag.defineSlot('/6326/politico-magazine/' + ad_pg, _ad_size, mod_id.toString()).setTargeting('tile', [ad_tile]).setTargeting('pos', [ad_pos]).addService(googletag.pubads()); 
			}
...
function post_ad(ad_type){
	...
	if (typeof gptadslots[ad_type] == 'undefined') {
		gptadslots[ad_type] = googletag.defineSlot('/6326/politico-magazine/' + ad_pg, _ad_size, mod_id.toString()).setTargeting('tile', [ad_tile]).setTargeting('pos', [ad_pos]).addService(googletag.pubads());
	}	
...
$(document).ready(function(){
	...
	//story only
	setTimeout(function() { 	
	if (PP_pagekey == 'magazine-story' || PP_pagekey == 'magazine-opinionstory' || PP_pagekey == 'magazine-storytest' || PP_pagekey == 'magazine-opinionstorytest') {
