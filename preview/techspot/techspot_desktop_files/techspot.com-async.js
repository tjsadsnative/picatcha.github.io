...
var _gaq = _gaq || [];
_gaq.push(['ns._setAccount', 'UA-46342437-35']);
...
(function() {
  ...
  if (dm.indexOf("techspot.com/reviews/cpu/") >= 0 ||  
      dm.indexOf("techspot.com/reviews/smartphones/") >= 0 ||  
      dm.indexOf("techspot.com/reviews/graphics-cards/") >= 0 ||  
      dm.indexOf("techspot.com/reviews/storage/") >= 0 ) {
    var script = document.createElement('script');
    script.setAttribute('src', "//cdn.static.zdbb.net/js/walker-min.js");
