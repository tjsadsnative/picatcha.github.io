...
var ft1484879 = {
	params:window.ftParams_1484879||"",
	confID:window.ftConfID_1484879||"0",
	guid:window.ftGUID_1484879||"99999999999",
	ftId:'',
    ftImpId: window.ftImp1484879 && ftImp1484879.impID || '',
	pID:1484879,
	creativeID:"1182335",
	campaignID: "53695",
	exttrack:[],
	...
	width:"728",
	height:"90",
	altimg:"http://cdn.flashtalking.com/xre/148/1484879/1182335/image/1182335.gif",
	viewableImpressionURL: "http://servedby.flashtalking.com/imp/8/53695;1484879;202;pixel;AXM;AlamedaCountyFoodBankAlamedaCountyFoodBank2015AXMProgrammaticPREDDesktop2015RON728x90HTML5FTUS1/?",
    stump: "http://servedby.flashtalking.com",
	altimghref:"http://servedby.flashtalking.com/click/8/53695;1484879;1182335;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://donate.accfb.org/",
	switchArray:["altimg", "altimghref", "cdnSrc", "cdnGUID", "iDeviceImp", "statBaseURL", "viewableImpressionURL", "cdnSrc", "iDeviceImp"],
	statBaseURL:"http://stat8.flashtalking.com/reportV3/ft.stat?58101996-",
	divID:"ftdiv1484879",
	altimgID:"ftalt1484879",
    imgID: "ftImg1484879",
    frameID:"ftframe1484879",
	alttext:"Click here",
	altimgtarget:"_blank",
	altimgborder:"0",
	centreAd:true,
	...
	iDeviceImp:"http://servedby.flashtalking.com/imp/8/53695;1484879;207;guid;AXM;AlamedaCountyFoodBankAlamedaCountyFoodBank2015AXMProgrammaticPREDDesktop2015RON728x90HTML5FTUS1/?ft_guid=",
	secure: location.protocol === 'https:'||!!(document.querySelector&&document.querySelector('#ftscript_m1484879[src^="https:"]')) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc','')),
	adDisplayed: false,
    w: window,
    qsVars:[
        ["ftguid","ftGUID_1484879"],
        ["ftcfid","ftConfID_1484879"],
        ["ftcustom","ftCustom_1484879"],
        ["fttime","ftTimestamp_1484879"],
        ["ftsection","ftSection_1484879"],
        ["ft_id", "ftID"],
        ['ftimpid', 'ftImp1484879', 'impID']
    ],
	api: {
		fallbackAPI: {
            ft: null,
	...
	scriptLocation: document.getElementById('ftscript_m1484879'),
	$:function(el){
		var o=this,
		x = el||o.divID,
		p={o:o};
	...
	outputDiv:function(frame){
		...
		div += o[content]();
		div += '</div>';
		if(window.ftImp1484879 && ftImp1484879.jsAppend) {
