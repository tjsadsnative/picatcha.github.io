...
c.AdWidth+"%3B%20height%3A%20"+c.AdHeight+"%3B%22%3E%09%0A%3C%2Fdiv%3E"))}}}function M(e){var a=null,g=null,c;var b=e.src,d=dv_GetParam(b,"cmp"),b=dv_GetParam(b,"ctx");c="919838"==b&&"7951767"==d||"919839"==b&&"7939985"==d||"971108"==b&&"7900229"==d||"971108"==b&&"7951940"==d?"</scr'+'ipt>":/<\/scr\+ipt>/g;"function"!==typeof String.prototype.trim&&(String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,"")});var r=function(b){if((b=b.previousSibling)&&"#text"==b.nodeName&&(null==b.nodeValue||
void 0==b.nodeValue||0==b.nodeValue.trim().length))b=b.previousSibling;if(b&&"SCRIPT"==b.tagName&&("text/adtag"==b.getAttribute("type").toLowerCase()||"text/passback"==b.getAttribute("type").toLowerCase())&&""!=b.innerHTML.trim()){if("text/adtag"==b.getAttribute("type").toLowerCase())return a=b.innerHTML.replace(c,"<\/script>"),{isBadImp:!1,hasPassback:!1,tagAdTag:a,tagPassback:g};if(null!=g)return{isBadImp:!0,hasPassback:!1,tagAdTag:a,tagPassback:g};g=b.innerHTML.replace(c,"<\/script>");b=r(b);b.hasPassback=
!0;return b}return{isBadImp:!0,hasPassback:!1,tagAdTag:a,tagPassback:g}};return r(e)}function E(e,a,g,c,b,d,r,k,s){var h,m,i;void 0==a.dvregion&&(a.dvregion=0);var t,q,F;try{i=c;for(m=0;10>m&&i!=window._dv_win.top;)m++,i=i.parent;c.depth=m;h=N(c);t="&aUrl="+encodeURIComponent(h.url);q="&aUrlD="+h.depth;F=c.depth+b;d&&c.depth--}catch(j){q=t=F=c.depth=""}void 0!=a.aUrl&&(t="&aUrl="+a.aUrl);b=a.script.src;d="&ctx="+(dv_GetParam(b,"ctx")||"")+"&cmp="+(dv_GetParam(b,"cmp")||"")+"&plc="+(dv_GetParam(b,
"plc")||"")+"&sid="+(dv_GetParam(b,"sid")||"")+"&advid="+(dv_GetParam(b,"advid")||"")+"&adsrv="+(dv_GetParam(b,"adsrv")||"")+"&unit="+(dv_GetParam(b,"unit")||"")+"&uid="+a.uid+"&tagtype="+(dv_GetParam(b,"tagtype")||"")+"&adID="+(dv_GetParam(b,"adID")||"");(i=dv_GetParam(b,"xff"))&&(d+="&xff="+i);(i=dv_GetParam(b,"useragent"))&&(d+="&useragent="+i);if(void 0!=window._dv_win.$dvbs.CommonData.BrowserId&&void 0!=window._dv_win.$dvbs.CommonData.BrowserVersion&&void 0!=window._dv_win.$dvbs.CommonData.BrowserIdFromUserAgent)h=
window._dv_win.$dvbs.CommonData.BrowserId,m=window._dv_win.$dvbs.CommonData.BrowserVersion,i=window._dv_win.$dvbs.CommonData.BrowserIdFromUserAgent;else{var n=i?decodeURIComponent(i):navigator.userAgent;h=[{id:4,brRegex:"OPR|Opera",verRegex:"(OPR/|Version/)"},{id:1,brRegex:"MSIE|Trident/7.*rv:11|rv:11.*Trident/7|Edge/",verRegex:"(MSIE |rv:| Edge/)"},{id:2,brRegex:"Firefox",verRegex:"Firefox/"},{id:0,brRegex:"Mozilla.*Android.*AppleWebKit(?!.*Chrome.*)|Linux.*Android.*AppleWebKit.* Version/.*Chrome",
...
""]);f.push(["cpu",navigator.cpuClass||""]);f.push(["pf",navigator.platform||""]);f.push(["dnt",navigator.doNotTrack||""]);f.push(["canv",h()]);var p=f.join("=!!!=");if(null==p||""==p)A="";else{i=function(a){for(var b="",c,d=7;0<=d;d--)c=a>>>4*d&15,b+=c.toString(16);return b};m=[1518500249,1859775393,2400959708,3395469782];var p=p+String.fromCharCode(128),y=Math.ceil((p.length/4+2)/16),z=Array(y);for(h=0;h<y;h++){z[h]=Array(16);for(f=0;16>f;f++)z[h][f]=p.charCodeAt(64*h+4*f)<<24|p.charCodeAt(64*h+
4*f+1)<<16|p.charCodeAt(64*h+4*f+2)<<8|p.charCodeAt(64*h+4*f+3)}z[y-1][14]=8*(p.length-1)/Math.pow(2,32);z[y-1][14]=Math.floor(z[y-1][14]);z[y-1][15]=8*(p.length-1)&4294967295;var p=1732584193,f=4023233417,n=2562383102,G=271733878,H=3285377520,u=Array(80),B,v,w,x,I;for(h=0;h<y;h++){for(var l=0;16>l;l++)u[l]=z[h][l];for(l=16;80>l;l++)u[l]=(u[l-3]^u[l-8]^u[l-14]^u[l-16])<<1|(u[l-3]^u[l-8]^u[l-14]^u[l-16])>>>31;B=p;v=f;w=n;x=G;I=H;for(l=0;80>l;l++){var D=Math.floor(l/20),E=B<<5|B>>>27,C;c:{switch(D){case 0:C=
v&w^~v&x;break c;case 1:C=v^w^x;break c;case 2:C=v&w^v&x^w&x;break c;case 3:C=v^w^x;break c}C=void 0}var J=E+C+I+m[D]+u[l]&4294967295;I=x;x=w;w=v<<30|v>>>2;v=B;B=J}p=p+B&4294967295;f=f+v&4294967295;n=n+w&4294967295;G=G+x&4294967295;H=H+I&4294967295}A=i(p)+i(f)+i(n)+i(G)+i(H)}}catch(L){A=null}a=(window._dv_win.dv_config.verifyJSURL||a.protocol+"//"+(window._dv_win.dv_config.bsAddress||"rtb"+a.dvregion+".doubleverify.com")+"/verify.js")+"?jsCallback="+a.callbackName+"&jsTagObjCallback="+a.tagObjectCallbackName+
"&num=6"+d+"&srcurlD="+c.depth+"&ssl="+a.ssl+"&refD="+F+a.tagIntegrityFlag+a.tagHasPassbackFlag+"&htmlmsging="+(r?"1":"0")+(null!=A?"&aadid="+A:"");(c=dv_GetDynamicParams(b).join("&"))&&(a+="&"+c);if(!1===k||s)a=a+("&dvp_isBodyExistOnLoad="+(k?"1":"0"))+("&dvp_isOnHead="+(s?"1":"0"));g="srcurl="+encodeURIComponent(g);if((k=window._dv_win[K("=@42E:@?")][K("2?46DE@C~C:8:?D")])&&0<k.length){s=[];s[0]=window._dv_win.location.protocol+"//"+window._dv_win.location.hostname;for(c=0;c<k.length;c++)s[c+1]=
k[c];k=s.reverse().join(",")}else k=null;k&&(g+="&ancChain="+encodeURIComponent(k));k=4E3;/MSIE (\d+\.\d+);/.test(navigator.userAgent)&&7>=new Number(RegExp.$1)&&(k=2E3);if(b=dv_GetParam(b,"referrer"))b="&referrer="+b,a.length+b.length<=k&&(a+=b);t.length+q.length+a.length<=k&&(a+=q,g+=t);"prerender"===window._dv_win.document.visibilityState&&(a+="&prndr=1");return a+="&eparams="+encodeURIComponent(K(g))+"&"+e.getVersionParamName()+"="+e.getVersion()}function N(e){try{if(1>=e.depth)return{url:"",
depth:""};var a,g=[];g.push({win:window._dv_win.top,depth:0});for(var c,b=1,d=0;0<b&&100>d;){try{if(d++,c=g.shift(),b--,0<c.win.location.toString().length&&c.win!=e)return 0==c.win.document.referrer.length||0==c.depth?{url:c.win.location,depth:c.depth}:{url:c.win.document.referrer,depth:c.depth-1}}catch(r){}a=c.win.frames.length;for(var k=0;k<a;k++)g.push({win:c.win.frames[k],depth:c.depth+1}),b++}return{url:"",depth:""}}catch(s){return{url:"",depth:""}}}function K(e){new String;var a=new String,
...
a=void 0!=g.style.textShadow}catch(c){}return 0<Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor")&&a&&void 0!=window.innerWidth&&void 0!=window.innerHeight?5:0}catch(b){return 0}}this.createRequest=function(){var e=!1,a=window._dv_win,g=0,c=!1;try{for(dv_i=0;10>=dv_i;dv_i++)if(null!=a.parent&&a.parent!=a)if(0<a.parent.location.toString().length)a=a.parent,g++,e=!0;else{e=!1;break}else{0==dv_i&&(e=!0);break}}catch(b){e=!1}0==a.document.referrer.length?e=a.location:e?e=a.location:
(e=a.document.referrer,c=!0);window._dv_win._dvScripts||(window._dv_win._dvScripts=[]);var d=document.getElementsByTagName("script");for(dv_i in d)if(d[dv_i].src){var r=d[dv_i].src,k=window._dv_win.dv_config.bs_regex||/^[ \t]*(http(s)?:\/\/)?[a-z\-]*cdn(s)?\.doubleverify\.com:?[0-9]*\/dvbs_src\.js/;if(r&&r.match(k)&&!dv_Contains(window._dv_win._dvScripts,d[dv_i])){this.dv_script=d[dv_i];window._dv_win._dvScripts.push(d[dv_i]);var s;s=window._dv_win.dv_config?window._dv_win.dv_config.bst2tid?window._dv_win.dv_config.bst2tid:
window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():D():D();var h,k=window.parent.postMessage&&window.JSON,m=!0,i=!1;if("0"==dv_GetParam(r,"t2te")||window._dv_win.dv_config&&!0==window._dv_win.dv_config.supressT2T)i=!0;if(k&&!1==i)try{var t=window._dv_win.dv_config.bst2turl||"https://cdn3.doubleverify.com/bst2tv3.html",i="bst2t_"+s,q=void 0;if(document.createElement&&(q=document.createElement("iframe")))q.name=q.id=window._dv_win.dv_config.emptyIframeID||"iframe_"+D(),q.width=
0,q.height=0,q.id=i,q.style.display="none",q.src=t;h=q;m=J(h)}catch(F){}var j;h=r;t={};try{for(var n=RegExp("[\\?&]([^&]*)=([^&#]*)","gi"),f=n.exec(h);null!=f;)"eparams"!==f[1]&&(t[f[1]]=f[2]),f=n.exec(h);j=t}catch(A){j=t}j.uid=s;j.script=this.dv_script;j.callbackName="__verify_callback_"+j.uid;j.tagObjectCallbackName="__tagObject_callback_"+j.uid;j.tagAdtag=null;j.tagPassback=null;j.tagIntegrityFlag="";j.tagHasPassbackFlag="";!1==(null!=j.tagformat&&"2"==j.tagformat)&&(n=M(j.script),j.tagAdtag=n.tagAdTag,
j.tagPassback=n.tagPassback,n.isBadImp?j.tagIntegrityFlag="&isbadimp=1":n.hasPassback&&(j.tagHasPassbackFlag="&tagpb=1"));j.protocol="http:";j.ssl="0";"https"==j.script.src.match("^https")&&"https"==window._dv_win.location.toString().match("^https")&&(j.protocol="https:",j.ssl="1");L(j);return E(this,j,e,a,g,c,k,m,d[dv_i]&&d[dv_i].parentElement&&d[dv_i].parentElement.tagName&&"HEAD"===d[dv_i].parentElement.tagName)}}};this.sendRequest=function(e){var a=dv_GetParam(e,"tagformat");a&&"2"==a?$dvbs.domUtilities.addScriptResource(e,
document.body):dv_sendScriptRequest(e);return!0};this.isApplicable=function(){return!0};this.onFailure=function(){var e=window._dv_win._dvScripts,a=this.dv_script;null!=e&&(void 0!=e&&a)&&(a=e.indexOf(a),-1!=a&&e.splice(a,1))};window.debugScript&&(window.CreateUrl=E);this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"25"}};
