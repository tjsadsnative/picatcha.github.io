    ...
    var ajaxPostLoadInit = function(callback){
        $.ajax({
            ...
            success: function(response) {
                ...
                nextPageBreak.innerHTML = '<hr><div class="ad leader-container"><div id="TBATF728" name="TBATF728" style="width:728px;height:90px;"></div></div><div class="ad full-width"></div><hr>';
