...
if(ptnrs.indexOf("google")>-1){if(!$iTXT.core.Browser.isSmartphone()){ok_to_launch=false;}
...
setTimeout(function(){el.className+=' animate';},20);},flipMobt:function(left,l_offset,t_offset){if(this.hasFlipped){this.ad.params.set("nott",0,9999);return;}
