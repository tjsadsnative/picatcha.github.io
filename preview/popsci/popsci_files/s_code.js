...
s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,doc,pdf,xls,jpg"
s.linkInternalFilters="javascript:,"+window.location.hostname;
s.linkLeaveQueryString=true
s.linkTrackVars="None"
s.linkTrackEvents="None"
s.formList="registerUserLoginForm"
s.trackFormList=true
s.trackPageName=true
s.useCommerce=true
s.varUsed="eVar27"
s.eventList="event11,event12,event13"
...
function s_doPlugins(s) {
  ...
  s.prop21=s.getTimeParting('h','-5',theYear); // Set hour 
  s.prop22=s.getTimeParting('d','-5',theYear); // Set day
  s.prop23=s.getTimeParting('w','-5',theYear); // Set Weekend / Weekday
  ...
  s.eVar12=s.prop12
  s.eVar13=s.prop13
  s.eVar17=s.prop17=document.URL  
  s.eVar18=s.prop18
  s.eVar21=s.prop21
  s.eVar22=s.prop22
  s.eVar23=s.prop23
  ...
  s.prop32=s.getNewRepeat(30,'s_getNewRepeat');
  s.eVar32=s.prop32

  if(location.href!=s.referrer){
    s.eVar36=s.getQueryParam('src');
    s.eVar37=s.getQueryParam('dom');
    s.eVar38=s.getQueryParam('lnk');
    s.eVar39=s.getQueryParam('con');
    s.eVar40=s.getQueryParam('loc');
    s.eVar36=s.eVar36.replace(/#.*/g,"");
    s.eVar37=s.eVar37.replace(/#.*/g,"");
    s.eVar38=s.eVar38.replace(/#.*/g,"");
    s.eVar39=s.eVar39.replace(/#.*/g,"");
    s.eVar40=s.eVar40.replace(/#.*/g,"");
  }
...
function plusoneTrack(obj){
  vars=s_gi(s_account);
  s.linkTrackVars='eVar41,eVar42,events';
...
/*
*facebookSocialPluginv1.1-stoppingthereferrerinflation
*/
...
/*
*Plugin:getNewRepeat1.2-Returnswhetheruserisneworrepeat
*/
...
s.visitorNamespace="bonniercorp"
s.trackingServer = "bonniercorp.122.2o7.net";
