document.write('<iframe id="pbSekindo_60687568320a66afb2"  FRAMEBORDER="0" SCROLLING="no" MARGINHEIGHT="0" MARGINWIDTH="0" TOPMARGIN="0" LEFTMARGIN="0" ALLOWTRANSPARENCY="true" WIDTH="300" HEIGHT="250"></iframe>');
    ...
    pbjs.que.push(function(){
		pbjs.requestBids({
            bidsBackHandler: function(bidResponses)
            {
				...
				var el = document.getElementById('pbSekindo_60687568320a66afb2');
				for(var i in bidResponses.pbSekindo_60687568320a66afb2.bids)
				{
					if( parseFloat(bidResponses.pbSekindo_60687568320a66afb2.bids[i].cpm) > parseFloat(maxCpm)*parseFloat(bidResponses.pbSekindo_60687568320a66afb2.bids[i].flrAdjst))
					{
						maxCpm = bidResponses.pbSekindo_60687568320a66afb2.bids[i].cpm;
						winnerBid = bidResponses.pbSekindo_60687568320a66afb2.bids[i];
					}
				}
