...
function dv_handler72(){function L(d){if(window._dv_win.document.body)return window._dv_win.document.body.insertBefore(d,window._dv_win.document.body.firstChild),!0;var a=0,c=function(){if(window._dv_win.document.body)try{window._dv_win.document.body.insertBefore(d,window._dv_win.document.body.firstChild)}catch(e){}else a++,150>a&&setTimeout(c,20)};setTimeout(c,20);return!1}function ca(d){var a;if(document.createElement&&(a=document.createElement("iframe")))a.name=a.id=window._dv_win.dv_config.emptyIframeID||
"iframe_"+Math.floor(1E12*(Math.random()+"")),a.width=0,a.height=0,a.style.display="none",a.src=d;return a}function wa(d){var a={};try{for(var c=RegExp("[\\?&]([^&]*)=([^&#]*)","gi"),e=c.exec(d);null!=e;)"eparams"!==e[1]&&(a[e[1]]=e[2]),e=c.exec(d);return a}catch(f){return a}}function Sa(d){try{if(1>=d.depth)return{url:"",depth:""};var a,c=[];c.push({win:window._dv_win.top,depth:0});for(var e,f=1,C=0;0<f&&100>C;){try{if(C++,e=c.shift(),f--,0<e.win.location.toString().length&&e.win!=d)return 0==e.win.document.referrer.length||
...
47)%94)),a+=f;return a}function Ta(){try{if("function"===typeof window.callPhantom)return 99;try{if("function"===typeof window.top.callPhantom)return 99}catch(d){}if(void 0!=window.opera&&void 0!=window.history.navigationMode||void 0!=window.opr&&void 0!=window.opr.addons&&"function"==typeof window.opr.addons.installExtension)return 4;if(void 0!=window.chrome&&"function"==typeof window.chrome.csi&&"function"==typeof window.chrome.loadTimes&&void 0!=document.webkitHidden&&(!0==document.webkitHidden||
...
C=0,xa=!1,x=getCurrentTime();window._dv_win.t2tTimestampData=[{dvTagCreated:x}];var D;try{for(D=0;10>=D;D++)if(null!=f.parent&&f.parent!=f)if(0<f.parent.location.toString().length)f=f.parent,C++,e=!0;else{e=!1;break}else{0==D&&(e=!0);break}}catch(fb){e=!1}var E;0==f.document.referrer.length?E=f.location:e?E=f.location:(E=f.document.referrer,xa=!0);var ya="",ea=null,fa=null;try{window._dv_win.external&&(ea=void 0!=window._dv_win.external.QueuePageID?window._dv_win.external.QueuePageID:null,fa=void 0!=
window._dv_win.external.CrawlerUrl?window._dv_win.external.CrawlerUrl:null)}catch(gb){ya="&dvp_extErr=1"}if(!window._dv_win._dvScriptsInternal||!window._dv_win.dvProcessed||0==window._dv_win._dvScriptsInternal.length)return null;var M=window._dv_win._dvScriptsInternal.pop(),y=M.script;this.dv_script_obj=M;this.dv_script=y;window._dv_win.t2tTimestampData[0].dvWrapperLoadTime=M.loadtime;window._dv_win.dvProcessed.push(M);var b=y.src,r,Ua="https:"===window._dv_win.location.protocol?"https:":"http:",
ga=!0,ha=window.parent.postMessage&&window.JSON,za=!1;if("0"==dv_GetParam(b,"t2te")||window._dv_win.dv_config&&!0===window._dv_win.dv_config.supressT2T)za=!0;if(ha&&!1===za)try{r=ca(window._dv_win.dv_config.t2turl||"https://cdn3.doubleverify.com/t2tv7.html"),ga=L(r)}catch(hb){}window._dv_win.$dv.DebugInfo.dvp_HTML5=ha?"1":"0";var N=dv_GetParam(b,"region")||"",ia="http:",Aa="0";"https"==b.match("^https")&&"https"==window._dv_win.location.toString().match("^https")&&(ia="https:",Aa="1");try{for(var Va=
f,ja=f,ka=0;10>ka&&ja!=window._dv_win.top;)ka++,ja=ja.parent;Va.depth=ka;var Ba=Sa(f);dv_aUrlParam="&aUrl="+encodeURIComponent(Ba.url);dv_aUrlDepth="&aUrlD="+Ba.depth;dv_referrerDepth=f.depth+C;xa&&f.depth--}catch(ib){dv_aUrlDepth=dv_aUrlParam=dv_referrerDepth=f.depth=""}for(var Ca=dv_GetDynamicParams(b,"dvp"),O=dv_GetDynamicParams(b,"dvpx"),P=0;P<O.length;P++){var Da=dv_GetKeyValue(O[P]);O[P]=Da.key+"="+encodeURIComponent(Da.value)}"41"==N&&(N=50>100*Math.random()?"41":"8",Ca.push("dvp_region="+
N));var Ea=Ca.join("&"),Fa=O.join("&"),Wa=window._dv_win.dv_config.tpsAddress||"tps"+N+".doubleverify.com",F="visit.js";switch(dv_GetParam(b,"dvapi")){case "1":F="dvvisit.js";break;case "5":F="query.js";break;default:F="visit.js"}window._dv_win.$dv.DebugInfo.dvp_API=F;for(var Q="ctx cmp ipos sid plc adid crt btreg btadsrv adsrv advid num pid crtname unit chnl uid scusrid tagtype sr dt isdvvid".split(" "),la=[],m=0;m<Q.length;m++){var ma=dv_GetParam(b,Q[m])||"";la.push(Q[m]+"="+ma);""!==ma&&(window._dv_win.$dv.DebugInfo["dvp_"+
Q[m]]=ma)}for(var na="turl icall dv_callback useragent xff timecheck".split(" "),m=0;m<na.length;m++){var Ga=dv_GetParam(b,na[m]);null!=Ga&&la.push(na[m]+"="+(Ga||""))}var Xa=la.join("&"),s;var Ya=function(){try{return!!window.sessionStorage}catch(b){return!0}},Za=function(){try{return!!window.localStorage}catch(b){return!0}},$a=function(){var b=document.createElement("canvas");if(b.getContext&&b.getContext("2d")){var a=b.getContext("2d");a.textBaseline="top";a.font="14px 'Arial'";a.textBaseline=
"alphabetic";a.fillStyle="#f60";a.fillRect(0,0,62,20);a.fillStyle="#069";a.fillText("!image!",2,15);a.fillStyle="rgba(102, 204, 0, 0.7)";a.fillText("!image!",4,17);return b.toDataURL()}return null};try{var n=[];n.push(["lang",navigator.language||navigator.browserLanguage]);n.push(["tz",(new Date).getTimezoneOffset()]);n.push(["hss",Ya()?"1":"0"]);n.push(["hls",Za()?"1":"0"]);n.push(["odb",typeof window.openDatabase||""]);n.push(["cpu",navigator.cpuClass||""]);n.push(["pf",navigator.platform||""]);
n.push(["dnt",navigator.doNotTrack||""]);n.push(["canv",$a()]);var i=n.join("=!!!=");if(null==i||""==i)s="";else{for(var G=function(a){for(var b="",d,c=7;0<=c;c--)d=a>>>4*c&15,b+=d.toString(16);return b},ab=[1518500249,1859775393,2400959708,3395469782],i=i+String.fromCharCode(128),t=Math.ceil((i.length/4+2)/16),u=Array(t),h=0;h<t;h++){u[h]=Array(16);for(var v=0;16>v;v++)u[h][v]=i.charCodeAt(64*h+4*v)<<24|i.charCodeAt(64*h+4*v+1)<<16|i.charCodeAt(64*h+4*v+2)<<8|i.charCodeAt(64*h+4*v+3)}u[t-1][14]=
8*(i.length-1)/Math.pow(2,32);u[t-1][14]=Math.floor(u[t-1][14]);u[t-1][15]=8*(i.length-1)&4294967295;for(var R=1732584193,S=4023233417,T=2562383102,U=271733878,V=3285377520,j=Array(80),z,k,p,q,W,h=0;h<t;h++){for(var g=0;16>g;g++)j[g]=u[h][g];for(g=16;80>g;g++)j[g]=(j[g-3]^j[g-8]^j[g-14]^j[g-16])<<1|(j[g-3]^j[g-8]^j[g-14]^j[g-16])>>>31;z=R;k=S;p=T;q=U;W=V;for(g=0;80>g;g++){var Ha=Math.floor(g/20),bb=z<<5|z>>>27,A;c:{switch(Ha){case 0:A=k&p^~k&q;break c;case 1:A=k^p^q;break c;case 2:A=k&p^k&q^p&q;break c;
case 3:A=k^p^q;break c}A=void 0}var cb=bb+A+W+ab[Ha]+j[g]&4294967295;W=q;q=p;p=k<<30|k>>>2;k=z;z=cb}R=R+z&4294967295;S=S+k&4294967295;T=T+p&4294967295;U=U+q&4294967295;V=V+W&4294967295}s=G(R)+G(S)+G(T)+G(U)+G(V)}}catch(jb){s=null}s=null!=s?"&aadid="+s:"";var Ia=b,b=(window._dv_win.dv_config.visitJSURL||ia+"//"+Wa+"/"+F)+"?"+Xa+"&dvtagver=6.1.src&srcurlD="+f.depth+"&curl="+(null==fa?"":encodeURIComponent(fa))+"&qpgid="+(null==ea?"":ea)+"&ssl="+Aa+"&refD="+dv_referrerDepth+"&htmlmsging="+(ha?"1":"0")+
s+ya,l=window._dv_win.$dv.getMraid();l&&(b+="&ismraid=1");var oa;a:{try{if("object"==typeof window.$ovv||"object"==typeof window.parent.$ovv){oa=!0;break a}}catch(kb){}oa=!1}oa&&(b+="&isovv=1");"http:"==b.match("^http:")&&"https"==window._dv_win.location.toString().match("^https")&&(b+="&dvp_diffSSL=1");var Ja=y&&y.parentElement&&y.parentElement.tagName&&"HEAD"===y.parentElement.tagName;if(!1===ga||Ja)b+="&dvp_isBodyExistOnLoad="+(ga?"1":"0"),b+="&dvp_isOnHead="+(Ja?"1":"0");Ea&&(b+="&"+Ea);Fa&&(b+=
...
B[w].verRegex)break;var sa=Na.match(RegExp(B[w].verRegex+"[0-9]*"));if(null!=sa)var db=sa[0].match(RegExp(B[w].verRegex)),Oa=sa[0].replace(db[0],"");break}var Pa=Ta();d=Pa;a=Pa===ra?Oa:"";c=ra;window._dv_win.$dv.CommonData.BrowserId=d;window._dv_win.$dv.CommonData.BrowserVersion=a;window._dv_win.$dv.CommonData.BrowserIdFromUserAgent=c}b+="&brid="+d+"&brver="+a+"&bridua="+c;window._dv_win.$dv.DebugInfo.dvp_BRID=d;window._dv_win.$dv.DebugInfo.dvp_BRVR=a;window._dv_win.$dv.DebugInfo.dvp_BRIDUA=c;var J;
void 0!=window._dv_win.$dv.CommonData.Scenario?J=window._dv_win.$dv.CommonData.Scenario:(J=this.getTrafficScenarioType(window._dv_win),window._dv_win.$dv.CommonData.Scenario=J);b+="&tstype="+J;window._dv_win.$dv.DebugInfo.dvp_TS=J;var $="";try{window.top==window?$="1":window.top.location.host==window.location.host&&($="2")}catch(lb){$="3"}var aa=window._dv_win.document.visibilityState,ta=l&&"function"===typeof l.getState&&"loading"===l.getState();if("prerender"===aa||ta)b+="&prndr=1",ta&&(b+="&dvp_mrprndr=1");
var Qa="dvCallback_"+(window._dv_win.dv_config&&window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():dv_GetRnd()),eb=this.dv_script;window._dv_win[Qa]=function(a,d,c,e){var f=getCurrentTime();d.$uid=c;d=wa(Ia);a.tags.add(c,d);d=wa(b);a.tags[c].set(d);a.tags[c].beginVisitCallbackTS=f;a.tags[c].set({tagElement:eb,dv_protocol:ia,protocol:Ua,uid:c});a.tags[c].ImpressionServedTime=getCurrentTime();a.tags[c].getTimeDiff=function(){return(new Date).getTime()-this.ImpressionServedTime};
try{"undefined"!=typeof e&&null!==e&&(a.tags[c].ServerPublicDns=e),a.tags[c].adServingScenario=$,a.tags[c].t2tIframeCreationTime=x,a.tags[c].t2tProcessed=!1,a.tags[c].t2tIframeId=r.id,a.tags[c].t2tIframeWindow=r.contentWindow,$dv.t2tEventDataZombie[r.id]&&(a.tags[c].uniquePageViewId=$dv.t2tEventDataZombie[r.id].uniquePageViewId,$dv.processT2TEvent($dv.t2tEventDataZombie[r.id],a.tags[c]))}catch(g){}if("prerender"===aa)if("prerender"!==window._dv_win.document.visibilityState&&"unloaded"!==visibilityStateLocal)a.registerEventCall(c,
{prndr:0});else{var h;"undefined"!==typeof window._dv_win.document.hidden?h="visibilitychange":"undefined"!==typeof window._dv_win.document.mozHidden?h="mozvisibilitychange":"undefined"!==typeof window._dv_win.document.msHidden?h="msvisibilitychange":"undefined"!==typeof window._dv_win.document.webkitHidden&&(h="webkitvisibilitychange");var i=function(){var b=window._dv_win.document.visibilityState;"prerender"===aa&&("prerender"!==b&&"unloaded"!==b)&&(aa=b,a.registerEventCall(c,{prndr:0}),window._dv_win.document.removeEventListener(h,
i))};window._dv_win.document.addEventListener(h,i,!1)}else if(ta){var j=function(){"function"===typeof l.removeEventListener&&l.removeEventListener("ready",j);a.registerEventCall(c,{prndr:0})};l&&"function"===typeof l.getState&&"loading"===l.getState()?"function"===typeof l.addEventListener&&l.addEventListener("ready",j):a.registerEventCall(c,{prndr:0})}};for(var Ra,ba="auctionid vermemid source buymemid anadvid ioid cpgid cpid sellerid pubid advcode iocode cpgcode cpcode pubcode prcpaid auip auua".split(" "),
ua=[],K=0;K<ba.length;K++){var va=dv_GetParam(Ia,ba[K]);null!=va&&(ua.push("dvp_"+ba[K]+"="+va),ua.push(ba[K]+"="+va))}(Ra=ua.join("&"))&&(b+="&"+Ra);return b+"&jsCallback="+Qa};this.sendRequest=function(d){var a;a=this.getVersionParamName();var c=this.getVersion(),e={};e[a]=c;e.dvp_jsErrUrl=d;e.dvp_jsErrMsg=encodeURIComponent("Error loading visit.js");window._dv_win.dv_config=window._dv_win.dv_config||{};window._dv_win.dv_config.tpsErrAddress=window._dv_win.dv_config.tpsAddress||"tps30.doubleverify.com";
...
d||window,a=d._dv_win.$dv.Enums.TrafficScenario;try{if(d.top==d)return a.OnPage;for(var c=0;d.parent!=d&&1E3>c;){if(d.parent.document.domain!=d.document.domain)return a.CrossDomain;d=d.parent;c++}return a.SameDomain}catch(e){}return a.CrossDomain};this.getVersionParamName=function(){return"jsver"};this.getVersion=function(){return"72"}};
...
a||window,d=a._dv_win.$dv.Enums.TrafficScenario;try{if(a.top==a)return d.OnPage;for(var c=0;a.parent!=a&&1E3>c;){if(a.parent.document.domain!=a.document.domain)return d.CrossDomain;a=a.parent;c++}return d.SameDomain}catch(e){}return d.CrossDomain};this.getVersionParamName=function(){return"jsver"};this.getVersion=function(){return"71"}};
...
try {
	...
	dv_handler72.prototype = dv_baseHandlerIns;
dv_handler72.prototype.constructor = dv_handler72;

    var dv_handlersDefs = [{handler: new dv_handler72(), minRate: 0, maxRate: 10}];
