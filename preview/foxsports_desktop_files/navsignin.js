...
// Timestamp: 2014.12.23-11:40:46 (last modified)  
  ...
  var navsignin = {
    ...
    toggleSignedin : function () {
      ...
      if (signinContainerElem &&
        ...
        signinContainerElem.className = "site-user-controls logged-in";
      }
    },
    ...
    toggleSignedout : function () {
      ...
      if (signinContainerElem && signinFontIconElem) {
        ...
        signinContainerElem.className = "site-user-controls logged-out";
      }
    },
