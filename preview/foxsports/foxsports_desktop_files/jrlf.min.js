...
}},userResetPasswordFinish:function(){this.invalidateSession();
...
h.onSessionInvalidatedHook.addFn(function(){if(window.top.location.href.match(/account\/settings/gi)||window.top.location.href.match(/account\/profile/gi)){c(g.urls.accountlogin)
}else{c()
}});
return h
