...
AdsNative match URL endpoint (**ANcm**):   <code>http[s]://rudy.adsnative.com/cm.gif</code>
...
>        -  **buid** - DSP’s user cookie id <br> http://rudy.adsnative.com/cm.gif?dspid=1234&buid=HJPK4VSL 
...
```
 http://rudy.adsnative.com/cm.gif?smode=2&dspid=1234&buid=HJPK4VSL&rurl=http%3A//ad.dsp.com/match.gif
```
