...
e=a.location:e?e=a.location:(e=a.document.referrer,c=!0);window._dv_win._dvScripts||(window._dv_win._dvScripts=[]);var d=document.getElementsByTagName("script");for(dv_i in d)if(d[dv_i].src){var r=d[dv_i].src,k=window._dv_win.dv_config.bs_regex||/^[ \t]*(http(s)?:\/\/)?[a-z\-]*cdn(s)?\.doubleverify\.com:?[0-9]*\/dvbs_src\.js/;if(r&&r.match(k)&&!dv_Contains(window._dv_win._dvScripts,d[dv_i])){this.dv_script=d[dv_i];window._dv_win._dvScripts.push(d[dv_i]);var s;s=window._dv_win.dv_config?window._dv_win.dv_config.bst2tid?
window._dv_win.dv_config.bst2tid:window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():D():D();var h,k=window.parent.postMessage&&window.JSON,m=!0,i=!1;if("0"==dv_GetParam(r,"t2te")||window._dv_win.dv_config&&!0==window._dv_win.dv_config.supressT2T)i=!0;if(k&&!1==i)try{var t=window._dv_win.dv_config.bst2turl||"https://cdn3.doubleverify.com/bst2tv3.html",i="bst2t_"+s,q=void 0;if(document.createElement&&(q=document.createElement("iframe")))q.name=q.id=window._dv_win.dv_config.emptyIframeID||
"iframe_"+D(),q.width=0,q.height=0,q.id=i,q.style.display="none",q.src=t;h=q;m=J(h)}catch(F){}var j;h=r;t={};try{for(var n=RegExp("[\\?&]([^&]*)=([^&#]*)","gi"),f=n.exec(h);null!=f;)"eparams"!==f[1]&&(t[f[1]]=f[2]),f=n.exec(h);j=t}catch(A){j=t}j.perf=this.perf;j.uid=s;j.script=this.dv_script;j.callbackName="__verify_callback_"+j.uid;j.tagObjectCallbackName="__tagObject_callback_"+j.uid;j.tagAdtag=null;j.tagPassback=null;j.tagIntegrityFlag="";j.tagHasPassbackFlag="";!1==(null!=j.tagformat&&"2"==j.tagformat)&&
(n=M(j.script),j.tagAdtag=n.tagAdTag,j.tagPassback=n.tagPassback,n.isBadImp?j.tagIntegrityFlag="&isbadimp=1":n.hasPassback&&(j.tagHasPassbackFlag="&tagpb=1"));j.protocol="http:";j.ssl="0";"https"==j.script.src.match("^https")&&"https"==window._dv_win.location.toString().match("^https")&&(j.protocol="https:",j.ssl="1");L(j);this.perf&&this.perf.addTime("r4");return E(this,j,e,a,g,c,k,m,d[dv_i]&&d[dv_i].parentElement&&d[dv_i].parentElement.tagName&&"HEAD"===d[dv_i].parentElement.tagName)}}};this.sendRequest=
function(e){this.perf&&this.perf.addTime("r5");var a=dv_GetParam(e,"tagformat");a&&"2"==a?$dvbs.domUtilities.addScriptResource(e,document.body):dv_sendScriptRequest(e);this.perf&&this.perf.addTime("r6");return!0};this.isApplicable=function(){return!0};this.onFailure=function(){var e=window._dv_win._dvScripts,a=this.dv_script;null!=e&&(void 0!=e&&a)&&(a=e.indexOf(a),-1!=a&&e.splice(a,1))};window.debugScript&&(window.CreateUrl=E);this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"26"}}
;
