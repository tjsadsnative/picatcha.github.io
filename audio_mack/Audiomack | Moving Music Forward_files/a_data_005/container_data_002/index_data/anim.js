...
function init() {
	...
	function _startAnimation() {
		...
		.from(	bg_2		 ,	0.5,		{	x:xHide, ease:_bgEase		},"bg_2"		)
		.from(	gradient	 ,	0.5,		{	x:xHide, ease:_bgEase		},"bg_2"		)
		...
		//.to(	line_2_3 	,	_exit,		{	x:xHide, ease:_exitEase		},"line_2_out+=.375"	)

		//.from(	bg_3	 	,	0.5,		{	x:xHide, ease:_bgEase		},"bg3"					)
