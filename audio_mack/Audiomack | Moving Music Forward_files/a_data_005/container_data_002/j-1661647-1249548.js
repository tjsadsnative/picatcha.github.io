...
var ft1661647 = {
	confID:window.ftConfID_1661647||"0",
	GUID:window.ftGUID_1661647||"99999999999",
	ftId:'',
    ftImpId: window.ftImp1661647 && window.ftImp1661647.impID || '',
	params:window.ftParams_1661647||"",
	segment:window.ftSegment_1661647||"",
	segmentList:window.ftSegmentList_1661647||[],
	keyword:window.ftKeyword_1661647||"",
	ftReturn: window.ftReturn_1661647||"",
	exttrack:[],
	extscript:[""],
	pID:"1661647",
	cID:"52835",
	campaignID:"58197",
	siteName:"MediaMath",
	placementDescription:"SLNGDUSATONNAGDTDISMT1PPRxxxxxxxxxxADULTPRxxxxxxx300x250",
	creativeID:"1249548",
	width:300,
	height:250,
	divID:"ftdiv1661647",
	frameID:"ftframe1661647",
	altImgID:"ftalt1661647",
	altText:"Click here",
	altImgTarget:"_blank",
	altImgHref:"http://servedby.flashtalking.com/click/8/58197;1661647;1249548;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.sling.com/programming?cvosrc=Display.MediaMath.TONNAG&cvo_strategy=[FT_MMSTRATEGY]&cvo_dealid=[FT_MMDEALID]&cvo_site=[FT_MMDOMAIN]&cvo_versionid=[FT_CONFID]&cvo_pid=SLNGD_USA_TONNAG_DT_DIS_MT1_PPR_xxxxxxxxxx_ADULTPR_xxxxxxx_300x250",
    tracking3rdParty: {
        videoQuartiles: JSON.parse('[%thirdparty_video_quartiles%]'.replace(/^(\[%\w+%])?$/, '{}')),
        userEngagement: '[%thirdparty_user_engagement%]'.replace(/^\[%\w+%\]$/, '')
    },
	clickTags: ["http://servedby.flashtalking.com/click/8/58197;1661647;1249548;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.sling.com/programming?cvosrc=Display.MediaMath.TONNAG&cvo_strategy=[FT_MMSTRATEGY]&cvo_dealid=[FT_MMDEALID]&cvo_site=[FT_MMDOMAIN]&cvo_versionid=[FT_CONFID]&cvo_pid=SLNGD_USA_TONNAG_DT_DIS_MT1_PPR_xxxxxxxxxx_ADULTPR_xxxxxxx_300x250"],
	altImg:"http://servedby.flashtalking.com/imp/8/58197;1661647;204;gif;MediaMath;SLNGDUSATONNAGDTDISMT1PPRxxxxxxxxxxADULTPRxxxxxxx300x250/?",
	viewableImpressionURL: "http://servedby.flashtalking.com/imp/8/58197;1661647;202;pixel;MediaMath;SLNGDUSATONNAGDTDISMT1PPRxxxxxxxxxxADULTPRxxxxxxx300x250/?",
    stump: "http://servedby.flashtalking.com",
	file:"http://cdn.flashtalking.com/52835/1249548/index.html",
	serveDOM:"http://cdn.flashtalking.com",
	switchArray:["altImg","file", "serveDOM", "statBaseURL","altImgHref", "viewableImpressionURL"],
	statBaseURL:"http://stat8.flashtalking.com/reportV3/ft.stat?61889803-",
	centreAd:true,
	adWindow:null,
	mvt:false,
	blockBrowsers:"".split(","),
	...
	secure: location.protocol === 'https:'||!!(document.querySelector&&document.querySelector('#ftscript_m1661647[src^="https:"]')) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc','')),
	storeGUID:/iP(ad|hone|od)/.test(navigator.appVersion),
	scriptLocation: document.getElementById('ftscript_m1661647'),
	customPos: false,
	...
	outputDiv:function(fullAd){
		...
		if(badWrite || (window.ftImp1661647 && window.ftImp1661647.jsAppend)) {
...
(function(o) {
  ...
  var mmReplace = function(s) {
    ...
    trackUrl = mmReplace("https://dishdigital.sp1.convertro.com/view/vt/v1/dishdigital/15/cvo.gif?cvosrc=Display.MediaMath.TONNAG&cvo_strategy=[FT_MMSTRATEGY]&cvo_dealid=[FT_MMDEALID]&cvo_site=[FT_MMDOMAIN]&cvo_versionid=[FT_CONFID]&cvo_pid=SLNGD_USA_TONNAG_DT_DIS_MT1_PPR_xxxxxxxxxx_ADULTPR_xxxxxxx_300x250");
